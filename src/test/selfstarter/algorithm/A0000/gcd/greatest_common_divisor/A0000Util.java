...
public class A0000Util {
	...
	/*
	 * 循环较小数求最小公倍数 mod4 原理：从小到大便利每一种可能 Loop: i>min(ceil(larger)/2,smaller)
	 */
	...
	/*
	 * 辗转相除求最小公倍数 mod2 原理：y%x=k...b; y=kx+b; gcd(y,x)=gcd(x,b) Loop:Recursion
	 * x%b==0
	 */
	...
	/*
	 * 位移辗转相除求最小公倍数 mod3 原理：y%x=k...b; y=kx+b; gcd(y,x)=gcd(x,b) Loop:Recursion
	 * x%b==0
	 */
